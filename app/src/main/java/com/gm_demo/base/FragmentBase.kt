...
import com.gm_demo.network.model.HttpErrorCode
...
//        checkForInAppUpdate()
    ...
    /**
     * This is generic method based on the MutableLive Data Concept where value changed with Bottom sheet Live Data
    ...
    private fun setUpProgressBar() {
        viewModel?.getProgressBar()?.observe(this, Observer { t: Boolean ->
            ...
            } /*else if (_activity != null && getBaseActivity() is LoginActivity) {
                (_activity as LoginActivity).displayProgress(t)
            }*/
        })
    }
    ...
    private fun hideKeyboard() {
        if (_activity != null && _activity is MainActivity) {
            (_activity as MainActivity).hideKeyboard()
        }
    }
