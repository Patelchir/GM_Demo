...
import com.gm_demo.network.client.HttpCommonMethod
import com.gm_demo.network.client.ResponseHandler
import com.gm_demo.network.model.ErrorWrapper
...
open class BaseRepository {
     ...
     */
    suspend fun <T : Any> makeAPICall(call: suspend () -> Response<ResponseListData<T>>): ResponseHandler<ResponseListData<T>?> {
        try {
